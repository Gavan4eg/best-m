 ...
 */
    ...
    (() => {
        ...
        document.querySelectorAll(".phone-mask").forEach((function(input) {
            intlTelInput(input, {
                ...
                geoIpLookup: callback => {
                    ...
                    if (hostname === "localhost" || hostname === "127.0.0.1") callback("UA"); else fetch("https://ipinfo.io?token=<YOUR_TOKEN>").then((resp => resp.json())).then((resp => {
                        const country = resp && resp.country ? resp.country.toUpperCase() : "UA";
                        callback(country);
                    })).catch((() => {
                        callback("UA");
                    }));
                ...
                utilsScript: "/intl-tel-input/build/js/utils.js?1709392860975"
            });
        }));
        ...
        function initSliders() {
            var mainGallerySliders = document.querySelectorAll(".main-gallery__slider");
            if (mainGallerySliders) mainGallerySliders.forEach((function(mainGallerySliders) {
                new swiper_core_Swiper(mainGallerySliders, {
            ...
            if (document.querySelector(".mentioned__slider")) new swiper_core_Swiper(".mentioned__slider", {
                ...
                navigation: {
                    prevEl: ".mentioned-swiper-button-prev",
                    nextEl: ".mentioned-swiper-button-next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 3,
            ...
            if (document.querySelector(".photo-account__slider")) new swiper_core_Swiper(".photo-account__slider", {
                modules: [ Navigation, freeMode, Mousewheel ],
                observer: true,
                observeParents: true,
                spaceBetween: 15,
            ...
            if (document.querySelector(".viewed-profiles__slider")) new swiper_core_Swiper(".viewed-profiles__slider", {
                modules: [ Navigation, freeMode, Mousewheel ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
        ...
        if (dropDownWrapper) {
            ...
            dropDownListItems.forEach((function(item) {
                item.addEventListener("click", (function(e) {
                    e.stopPropagation();
                    const inner = this.querySelector(".side__inner");
                    if (!inner) return;
                    const text = inner.textContent;
                    const iconClass = Array.from(inner.classList).find((cls => cls.startsWith("_icon-")));
                    const btnInner = dropDownBtn.querySelector(".side__inner");
                    btnInner.textContent = text;
                    btnInner.className = "side__inner";
                    if (iconClass) btnInner.classList.add(iconClass);
                    closeDropdown();
                }));
            }));
            ...
            document.addEventListener("keydown", (function(e) {
                if (e.key === "Tab" || e.key === "Escape") closeDropdown();
            }));
